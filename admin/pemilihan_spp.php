        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card shadow mb-4">
                    <div class="card-header py-3 ">
                        <h3 class="text-primary"><b>Pemilihan SPP</b></h3>
                    </div>
                        <div class="card-body">
                            ...
                            <table class="table table-hover table-striped">
                                <thead class="bg-dark text-light">
                                    <th>No</th><th>Angkatan</th><th>Bulan</th><th>Nominal</th><th>Bayar</th>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                include'../koneksi.php';
                                $qry_spp = mysqli_query($sambung,"select * from spp where spp.angkatan = '".$_SESSION['angkatan']."'");
                                $no=0;
                                ...
                                if(mysqli_num_rows($qry_spp) > 0 && $data_spp['nominal'] == 0) {
                                    ...
                                    $button_pembayaran = "<a href='bayar_spp.php?id_spp=".$data_spp['id_spp']."' class='btn btn-primary' title='SPP Payment'>Pilih</a>";
                                }

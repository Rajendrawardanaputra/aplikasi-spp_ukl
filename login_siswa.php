...
if(isset($_GET['pesan'])){
    if($_GET['pesan']=="gagal"){
        echo "<script>alert('Username dan password tidak sesuai');location.href='login_petugas.php';</script>";
    }
}
?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="proses_login_siswa.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="" aria-describedby="emailHelp"
                                                placeholder="Enter NISN..." name="nisn">
                                        </div>
                                        <div class="form-group">

...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="halaman_administrator.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="halaman_administrator.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                        ...
                        <h1 class="text-dark" align="center"><b>SPP</b></h1>
                    <br>
